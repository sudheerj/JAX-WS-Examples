 ...
 * generated in the com.sudheer.webservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _HelloWorldResponse_QNAME = new QName("http://webservice.sudheer.com/", "helloWorldResponse");
    private final static QName _HelloWorld_QNAME = new QName("http://webservice.sudheer.com/", "helloWorld");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.sudheer.webservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.sudheer.com/", name = "helloWorldResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://webservice.sudheer.com/", name = "helloWorld")
